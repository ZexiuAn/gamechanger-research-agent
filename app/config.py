        ...
        try:
            ...
            with config_file.open() as f:
                ...
                for server_id, server_config in data.get("mcpServers", {}).items():
                    ...
                    # 解析 ${PYTHON} 与相对路径，便于跨机器演示
                    if command in (None, "", "python", "python3", "${PYTHON}"):
                        import sys
                    ...
                    if args:
                        ...
                        if not script.is_absolute():
                            args[0] = str(PROJECT_ROOT / script)
...
class Config:
    ...
    def _load_initial_config(self):
        ...
        # 优先使用配置文件中的 api_key，如果没有则从环境变量读取，缺省为空字符串
        api_key = (
            base_llm.get("api_key")
